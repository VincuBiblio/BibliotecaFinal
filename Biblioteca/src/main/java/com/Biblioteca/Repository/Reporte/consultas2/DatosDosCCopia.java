...
public interface DatosDosCCopia extends JpaRepository<ComputoCliente, Long> {
    ...
    @Query(value = "select p.cedula,p.nombres, p.apellidos, p.telefono, p.email, " +
            ...
            "and com.id_cliente IN (SELECT id_cliente FROM copias_cliente where mes= :mes and anio= :anio and dia=com.dia) " +
